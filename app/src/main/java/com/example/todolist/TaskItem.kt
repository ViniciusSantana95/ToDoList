...
)
{
    ...
    fun isCompeted() = completedDate() != null
    fun imageResource(): Int = if(isCompeted()) R.drawable.checked_24 else R.drawable.unchecked_24
    fun imageColor(context: Context) : Int = if(isCompeted()) purple(context) else black(context)
